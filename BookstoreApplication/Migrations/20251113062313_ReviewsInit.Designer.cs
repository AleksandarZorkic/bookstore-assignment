...
namespace BookstoreApplication.Migrations
{
    ...
    [Migration("20251113062313_ReviewsInit")]
    partial class ReviewsInit
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookstoreApplication.Models.Entities.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("BookstoreApplication.Models.Entities.Author", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BookstoreApplication.Models.Entities.AuthorAward", b =>
                {
            ...
            modelBuilder.Entity("BookstoreApplication.Models.Entities.Award", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BookstoreApplication.Models.Entities.Book", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BookstoreApplication.Models.Entities.ComicIssue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<long>("ExternalIssueId")
            ...
            modelBuilder.Entity("BookstoreApplication.Models.Entities.Publisher", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BookstoreApplication.Models.Entities.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BookstoreApplication.Models.Entities.AuthorAward", b =>
                {
                    b.HasOne("BookstoreApplication.Models.Entities.Author", "Author")
                        .WithMany("AuthorAwards")
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BookstoreApplication.Models.Entities.Award", "Award")
                        .WithMany("AuthorAwards")
            ...
            modelBuilder.Entity("BookstoreApplication.Models.Entities.Book", b =>
                {
                    ...
                    b.HasOne("BookstoreApplication.Models.Entities.Publisher", "Publisher")
                        .WithMany()
            ...
            modelBuilder.Entity("BookstoreApplication.Models.Entities.Review", b =>
                {
                    b.HasOne("BookstoreApplication.Models.Entities.Book", "Book")
                        .WithMany("Reviews")
                        .HasForeignKey("BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BookstoreApplication.Models.Entities.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BookstoreApplication.Models.Entities.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
